...
departures = {"msk":"Из Москвы","spb":"Из Петербурга","nsk":"Из Новосибирска","ekb":"Из Екатеринбурга","kazan":"Из Казани","sch":"Из Сочи"}
...
tours = {
    ...
    17: {
         ...
         "description": "Этот отель был введен для тестирования приложения на предмет масштабирования",
         "departure": "sch",
         "picture": "https://www.adventuress-travel-magazine.com/images/xRossiaHotelExterior.jpg.pagespeed.ic.LxvrJgptIw.jpg",
         "price": 888888,
         "stars": "5",
         "country": "СССР",
		"nights": 365,
